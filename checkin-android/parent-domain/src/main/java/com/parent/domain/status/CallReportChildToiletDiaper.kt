 ...
 */
class CallReportChildToiletDiaper(threadExecutor: ThreadExecutor,
    ...
    override fun buildUseCaseSingle(params: Params): Single<String> =
            statusesDataSource.reportChildrenDiaperToilet(params.get(ReportChildrenParams.PARAM_REQUEST))
}