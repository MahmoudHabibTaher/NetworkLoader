 ...
 */
class RemoveContactFromChild(threadExecutor: ThreadExecutor,
    ...
    override fun buildUseCaseSingle(params: Params): Single<String> =
            childContactsDataSource.removeContactFromChild(params.get(ParamsConstants.CHILD_ID), params.get(ParamsConstants.CONTACT_ID))
