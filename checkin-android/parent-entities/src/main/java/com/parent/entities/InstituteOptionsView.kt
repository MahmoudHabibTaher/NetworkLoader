 ...
 */
data class InstituteOptionsView(val id: String = "",
                                val name: String = "",
                                val avatar: String = "",
                                ...
                                val country: CountryView = CountryView(),
                                val city: CityView = CityView(),
                                val timezone: TimezoneView = TimezoneView(),
                                val canEdit: Boolean = false) {
    class Builder : IBuilder<InstituteOptionsView> {
        private var id = ""
        private var name = ""
        private var avatar = ""
        ...
        private var country: CountryView = CountryView()
        private var city: CityView = CityView()
        private var timezone: TimezoneView = TimezoneView()
        ...
        fun country(country: CountryView): Builder {
            this.country = country
            return this
        }

        fun city(city: CityView): Builder {
            this.city = city
            return this
        }

        fun timezone(timezone: TimezoneView): Builder {
        ...
        override fun build(): InstituteOptionsView =
                InstituteOptionsView(id, name, avatar, contactPerson, email, website, phone, lunchTime, weekStart,
        ...
        companion object {
            fun buildNormalInstituteOptions() =
                    Builder().id("1").name("Institute Name").avatar("avatar")
                            ...
                            .companyId("1")
                            .country(CountryView.TestBuilder.buildNormalCountry())
                            .city(CityView.TestBuilder.buildNormalCity())
                            .timezone(TimezoneView.TestBuilder.buildNormalTimezone())
                            .build()
        }
    }
}