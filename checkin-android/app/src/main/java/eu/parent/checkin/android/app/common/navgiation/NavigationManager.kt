package eu.parent.android.app.common.navgiation
...
class NavigationManager {
    ...
    val TEMP_FRAGMENT: String = "tempFragment"
    ...
    fun open(fragment: Fragment, containerId: Int = fragmentContainerId, openMethod: OpenMethod = OpenMethod.REPLACE, addToBackStack: Boolean = true) {
        fragmentManager?.let {
    ...
    fun removeTempFragment() {
        fragmentManager?.popBackStack(TEMP_FRAGMENT, FragmentManager.POP_BACK_STACK_INCLUSIVE)
