...
import eu.parent.android.app.common.presentation.fragments.BaseFragmentLifeCycleCallbacks
...
class BaseActivityLifeCycleCallbacks : Application.ActivityLifecycleCallbacks {
    ...
    override fun onActivityCreated(activity: Activity?, savedInstanceState: Bundle?) {
        ...
        activity.takeIf { it is AppCompatActivity }
                ...
                .let { it?.supportFragmentManager }
                .to(BaseFragmentLifeCycleCallbacks())
